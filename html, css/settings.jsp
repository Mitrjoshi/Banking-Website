...
<html lang="en">
  ...
  <body>
    ...
    Session.getAttribute("username"); String emailId = (String)
    Session.getAttribute("emailId"); String password = (String)
    Session.getAttribute("password"); String cardNumber = (String)
    Session.getAttribute("cardNumber"); String cardHolder = (String)
    Session.getAttribute("cardHolder"); String expirydate = (String)
    Session.getAttribute("expirydate"); String cvv = (String)
    Session.getAttribute("cvv"); int newBalance = (Integer)
    Session.getAttribute("newBalance"); %>
    ...
    <h1 class="jumbotron mt-5 mb-5 text-center">Settings</h1>
    <hr />

    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-md-4">
          <p class="mt-5">Profile</p>
          <h2><%=profileName%></h2>
          <p class="mt-5">Email id</p>
          <h2><%=emailId%></h2>

          <form class="= mt-5 mb-3" action="editDetails" method="post">
